...
namespace ChinchkarDAL
{
    public class SqlBaseClassDAL
    {
        ...
        {
            string Constr;
            Constr = System.Configuration.ConfigurationSettings.AppSettings["ConnectionString"].ToString();
            return Constr;
        }

        //Add by MAhesh For Reporting 
        ...
        public SqlCommand GetSqlCommandByQuery(string Query)
        {
            try
            {
                OpenConnection();
